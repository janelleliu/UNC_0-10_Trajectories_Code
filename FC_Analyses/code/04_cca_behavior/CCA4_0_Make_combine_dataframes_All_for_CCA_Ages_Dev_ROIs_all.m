...
for mm = 1:length(measures)
    ...
    for gg = 1:length(groups)
        ...
        measures_feature_Dev_twinPick_IQ_withMedu = measures_feature_Dev(ismember(subjects_twinPick_All, subjects_twinPick_IQ_withMedu), :);  %%!!  %%!!  Modify
        X = measures_feature_Dev_twinPick_IQ_withMedu;  %%!!  %%!!  Modify
        ...
        save([outdir 'Y.mat'], 'Y');
        save([outdir 'C.mat'], 'C');
        Normal_I = ismember(subjects_twinPick_IQ_withMedu, subjects_twinPick_Normal);  %%!!  
        ...
        measures_feature_Dev_twinPick_Anxiety_withMedu = measures_feature_Dev(ismember(subjects_twinPick_All, subjects_twinPick_Anxiety_withMedu), :);  %%!!  %%!!  Modify
        X = measures_feature_Dev_twinPick_Anxiety_withMedu;  %%!!  %%!!  Modify
        ...
        save([outdir 'Y.mat'], 'Y');
        save([outdir 'C.mat'], 'C');
        Normal_I = ismember(subjects_twinPick_Anxiety_withMedu, subjects_twinPick_Normal);  %%!!  
        save([outdir 'Normal_I.mat'], 'Normal_I');  %%!!  
