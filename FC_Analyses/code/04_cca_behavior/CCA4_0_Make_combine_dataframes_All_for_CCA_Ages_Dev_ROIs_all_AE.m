...
for mm = 1:length(measures)
    ...
    for gg = 1:length(groups)
        ...
        subjects_twinPick_AllEmotion = intersect(subjects_twinPick_Anxiety, subjects_twinPick_Depression);  %%!!  %%!!  subjects with all 2 Emotions
        Medu_twinPick_AllEmotion = Medu_all(ismember(subjects_all, subjects_twinPick_AllEmotion));  %%!!    %%!!  If need IN ORDER by using ISMEMBER, need to SORT every subject list first!!!!!!!!        
        subjects_twinPick_AllEmotion_withMedu = subjects_twinPick_AllEmotion(~isnan(Medu_twinPick_AllEmotion));  %%!!  with AllEmotion & with Medu  %%!!  
        Medu_twinPick_AllEmotion_withMedu = Medu_all(ismember(subjects_all, subjects_twinPick_AllEmotion_withMedu));  %%!!    %%!!  
        Medu_twinPick_AllEmotion_withMedu = Medu_twinPick_AllEmotion_withMedu - mean(Medu_twinPick_AllEmotion_withMedu);  %%!!    %%!!  centered
        NDD_twinPick_AllEmotion_withMedu = double(ismember(subjects_twinPick_AllEmotion_withMedu, subjects_twinPick_NDD));  %%!!    %%!!  categorized
        MPD_twinPick_AllEmotion_withMedu = double(ismember(subjects_twinPick_AllEmotion_withMedu, subjects_twinPick_MPD));  %%!!    %%!!  categorized
        GAAssess_twinPick_AllEmotion_withMedu = cell2mat(GAAssess_all(ismember(subjects_all, subjects_twinPick_AllEmotion_withMedu)));  %%!!    %%!!  
        GAAssess_twinPick_AllEmotion_withMedu = GAAssess_twinPick_AllEmotion_withMedu - mean(GAAssess_twinPick_AllEmotion_withMedu);  %%!!    %%!!  centered
        C_twinPick_AllEmotion_withMedu = CC(ismember(subjects_twinPick_All, subjects_twinPick_AllEmotion_withMedu), :);  %%!!    %%!!  categorized/centered GAB+GAS+BW+Sex for subjects_twinPick_AllEmotion_withMedu  %%!!  %%!!  
        C_twinPick_AllEmotion_withMedu = [C_twinPick_AllEmotion_withMedu, Medu_twinPick_AllEmotion_withMedu, NDD_twinPick_AllEmotion_withMedu, MPD_twinPick_AllEmotion_withMedu, GAAssess_twinPick_AllEmotion_withMedu];  %%!!    %%!!  All covs for longitudinal regression test (except for intercept 1+)
        %IQ_twinPick_AllEmotion_withMedu = IQ_all(ismember(subjects_all, subjects_twinPick_AllEmotion_withMedu));  %%!!    %%!!  no need to center
        Anxiety_twinPick_AllEmotion_withMedu = Anxiety_all(ismember(subjects_all, subjects_twinPick_AllEmotion_withMedu));  %%!!    %%!!  no need to center
        Depression_twinPick_AllEmotion_withMedu = Depression_all(ismember(subjects_all, subjects_twinPick_AllEmotion_withMedu));  %%!!    %%!!  no need to center
        measures_feature_Dev_twinPick_AllEmotion_withMedu = measures_feature_Dev(ismember(subjects_twinPick_All, subjects_twinPick_AllEmotion_withMedu), :);  %%!!  %%!!  Modify
        X = measures_feature_Dev_twinPick_AllEmotion_withMedu;  %%!!  %%!!  Modify
        Y = [Anxiety_twinPick_AllEmotion_withMedu, Depression_twinPick_AllEmotion_withMedu];  %%!!  %%!!  
        C = C_twinPick_AllEmotion_withMedu;  %%!!  
        ...
        save([outdir 'Y.mat'], 'Y');
        save([outdir 'C.mat'], 'C');
        Normal_I = ismember(subjects_twinPick_AllEmotion_withMedu, subjects_twinPick_Normal);  %%!!  
