...
for mm = 1:length(measures)
    ...
    for gg = 1:length(groups)
        ...
        measures_feature_AbsDev_twinPick_AllBehavior_withMedu = measures_feature_AbsDev(ismember(subjects_twinPick_All, subjects_twinPick_AllBehavior_withMedu), :);  %%!!  %%!!  Modify
        X = measures_feature_AbsDev_twinPick_AllBehavior_withMedu;  %%!!  %%!!  Modify
