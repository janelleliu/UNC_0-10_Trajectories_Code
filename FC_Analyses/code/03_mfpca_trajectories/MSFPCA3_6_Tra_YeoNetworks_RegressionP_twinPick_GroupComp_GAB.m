...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/MSFPCA3_New_tables_results/mFPCA/mfpca_results_GroupComp_GAB/' measure label Cov_label '/'];  %%!!    %%!!  
...
%     subjects_twinPick_UNP_32W = union(subjects_twinPick_Normal_32W, subjects_twinPick_Preterm_32W);  %%!!  Union of Normal/Preterm 32W
    ...
    subjects_twinPick_All_withMedu = subjects_twinPick_All(~isnan(Medu_twinPick_All));  %%!!  Union of All & with Medu  %%!!  
    ...
    C = C(:, [1,3]);  %%!!  C as categorized/centered GAB+Sex for subjects_twinPick_All
    C_twinPick_All_withMedu = C(ismember(subjects_twinPick_All, subjects_twinPick_All_withMedu), :);  %%!!    %%!!  categorized/centered GAB+Sex for subjects_twinPick_All_withMedu
    C_twinPick_All_withMedu = [C_twinPick_All_withMedu, Medu_twinPick_All_withMedu, MPD_twinPick_All_withMedu];  %%!!    %%!!  All covs for longitudinal regression test (except for intercept 1+)
    ...
    FPC_scores_twinPick_All_withMedu = cell2mat(FPC_scores(ismember(FPC_scores(:, 2), subjects_twinPick_All_withMedu), 4:end));  %%!!  
    n_FPC = size(FPC_scores_twinPick_All_withMedu, 2) / num_ROIs;
    FPC_1_scores_twinPick_All_withMedu = FPC_scores_twinPick_All_withMedu(:, 1:n_FPC:end);  %%!!    %%!!  1/2/3/4  1/2/3/4    
    %{
    ...
    %}
    Bs_GAB = zeros(1, num_ROIs);
    Ps_GAB = zeros(1, num_ROIs);
    %Bs_MPD = zeros(1, num_ROIs);
    %Ps_MPD = zeros(1, num_ROIs);
    alpha = 0.05;  %%!!  
    for rr = 1:num_ROIs
        y_twinPick_All_withMedu = FPC_1_scores_twinPick_All_withMedu(:, rr);  %%!!  1/2/3/4/Dev    
        %[B,~,R] = regress(y_twinPick_UNNM_withMedu, [ones(size(C_twinPick_UNNM_withMedu, 1), 1), C_twinPick_UNNM_withMedu]);  %%!!    %%!!  
        mdl = fitlm(C_twinPick_All_withMedu, y_twinPick_All_withMedu);  %%!!    %%!!  regress doesn't output individual p values; use fitlm instead, no need to include ones
        Bs_GAB(rr) = mdl.Coefficients.Estimate(2);  %%!!    %%!!  GAB
        Ps_GAB(rr) = mdl.Coefficients.pValue(2);  %%!!    %%!!  GAB
    ...
    outfile = [outputpath measure label '_mFPCA_twinPick_All_FPC_1_scores_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  All    1/2/3/4/Dev    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_All_withMedu', 'FPC_scores_twinPick_All_withMedu', 'FPC_1_scores_twinPick_All_withMedu', 'C_twinPick_All_withMedu', 'Bs_GAB', 'Ps_GAB', 'Hs_GAB', 'Ps_GAB_FDR', 'Hs_GAB_FDR');  %%!!    %%!!  1/2/3/4/Dev    
    ...
    for rr = 1:num_ROIs
        ...
        network = networks{rr};
        y_twinPick_All_withMedu = FPC_1_scores_twinPick_All_withMedu(:, rr);  %%!!  1/2/3/4/Dev    
%         y_twinPick_All_withMedu_Normal_32W = y_twinPick_All_withMedu(ismember(subjects_twinPick_All_withMedu, subjects_twinPick_Normal_32W));
%         y_twinPick_All_withMedu_Preterm_32W = y_twinPick_All_withMedu(ismember(subjects_twinPick_All_withMedu, subjects_twinPick_Preterm_32W));
        %y_twinPick_All_withMedu_NDD = y_twinPick_All_withMedu(ismember(subjects_twinPick_All_withMedu, subjects_twinPick_NDD));
        %y_twinPick_All_withMedu_MPD = y_twinPick_All_withMedu(ismember(subjects_twinPick_All_withMedu, subjects_twinPick_MPD));
        [Corr, P] = partialcorr(GAB_twinPick_All_withMedu, y_twinPick_All_withMedu, C_twinPick_All_withMedu(:, 2:end));  %%!!    %%!!  , 'Type', 'Spearman'
        Corrs_GAB(rr) = Corr;
        Ps_GAB(rr) = P;
        ...
        for pp = 1:perm_n
            perm_Corrs(pp) = partialcorr(perm_GAB_twinPick_All_withMedus{pp}, y_twinPick_All_withMedu, C_twinPick_All_withMedu(:, 2:end)); %% 
        end
        %{
        if Corr < 0
        ...
        ylabel([measure_str ' ' networks{rr} ' FPC 1 Scores']);  %%!!  
        ...
        hold off;
        outfilef = [outputpath measure label '_mFPCA_twinPick_GAB_FPC_1_scores_' num2str(rr) networks{rr} '_Scatter_' group Cov_label '.png'];  %%!!    %%!!  GAB    1/2/3/4/Dev    
        saveas(h_fig, outfilef);
        close(h_fig);  %  
        %{
        figure;
        Violin({y_twinPick_All_withMedu_Normal_32W}, 1, 'ShowMean', true);
        Violin({y_twinPick_All_withMedu_Preterm_32W}, 2, 'ShowMean', true);
...
%         figure;
%         Violin({y_twinPick_All_withMedu_Normal_32W}, 1, 'ShowMean', true);
%         Violin({y_twinPick_All_withMedu_MPD}, 2, 'ShowMean', true);
...
%         close;  
    ...
    outfile = [outputpath measure label '_mFPCA_twinPick_GAB_FPC_1_scores_PartialCorrP_' group Cov_label '.mat'];  %%!!    %%!!  GAB    1/2/3/4/Dev    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_All_withMedu', 'FPC_scores_twinPick_All_withMedu', 'FPC_1_scores_twinPick_All_withMedu', 'C_twinPick_All_withMedu', 'GAB_twinPick_All_withMedu', 'Corrs_GAB', 'Ps_GAB', 'Hs_GAB', 'Ps_GAB_FDR', 'Hs_GAB_FDR', 'PermPs_GAB', 'PermHs_GAB', 'PermPs_GAB_FDR', 'PermHs_GAB_FDR');  %%!!    %%!!  1/2/3/4/Dev    
    ...
    FPC_scores_twinPick_All_withMedu = cell2mat(FPC_scores(ismember(FPC_scores(:, 2), subjects_twinPick_All_withMedu), 4:end));  %%!!  
    n_FPC = size(FPC_scores_twinPick_All_withMedu, 2) / num_ROIs;
    FPC_2_scores_twinPick_All_withMedu = FPC_scores_twinPick_All_withMedu(:, 2:n_FPC:end);  %%!!    %%!!  1/2/3/4  1/2/3/4    
    %{
    norm_num = 2;  %%!!  number of FPCs to use  %%!!  n_FPC / 3 / 2 / 1
    FPC_Dev_scores_twinPick_UNNM_withMedu = zeros(size(FPC_scores_twinPick_UNNM_withMedu, 1), num_ROIs);
    for ss = 1:size(FPC_scores_twinPick_UNNM_withMedu, 1)
    ...
    alpha = 0.05;  %%!!  
    for rr = 1:num_ROIs
        y_twinPick_All_withMedu = FPC_2_scores_twinPick_All_withMedu(:, rr);  %%!!  1/2/3/4/Dev    
        %[B,~,R] = regress(y_twinPick_UNNM_withMedu, [ones(size(C_twinPick_UNNM_withMedu, 1), 1), C_twinPick_UNNM_withMedu]);  %%!!    %%!!  
        mdl = fitlm(C_twinPick_All_withMedu, y_twinPick_All_withMedu);  %%!!    %%!!  regress doesn't output individual p values; use fitlm instead, no need to include ones
        Bs_GAB(rr) = mdl.Coefficients.Estimate(2);  %%!!    %%!!  GAB
        Ps_GAB(rr) = mdl.Coefficients.pValue(2);  %%!!    %%!!  GAB
    ...
    %Ps_MPD_FDR = mafdr(Ps_MPD, 'BHFDR', true);
    %Hs_MPD_FDR = Ps_MPD_FDR <= alpha;
    outfile = [outputpath measure label '_mFPCA_twinPick_All_FPC_2_scores_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  All    1/2/3/4/Dev    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_All_withMedu', 'FPC_scores_twinPick_All_withMedu', 'FPC_2_scores_twinPick_All_withMedu', 'C_twinPick_All_withMedu', 'Bs_GAB', 'Ps_GAB', 'Hs_GAB', 'Ps_GAB_FDR', 'Hs_GAB_FDR');  %%!!    %%!!  1/2/3/4/Dev    
...
%         y_twinPick_All_withMedu_Preterm_32W = y_twinPick_All_withMedu(ismember(subjects_twinPick_All_withMedu, subjects_twinPick_Preterm_32W));
        ...
        l.LineWidth = 2;
        xlabel('Gestational Age at Birth');
        ylabel([measure_str ' ' networks{rr} ' FPC 2 Scores']);  %%!!  
        %title(['Sim ' sim_sstr ' - Demo ' demo_sstr]); %% 
        %xlim([ ]); %% 
        %ylim([-0.6 0.8]); %% 
        set(gca, 'FontSize', 15, 'FontWeight', 'bold');  %%!!  Updated
        ...
        annotation('textbox', [0.68, 0.80, 0.1, 0.1], 'String', ['PermP: ' PermP_str], 'EdgeColor', 'none', 'FontSize', 15, 'FontWeight', 'bold');  %%!!  Updated
        hold off;
        outfilef = [outputpath measure label '_mFPCA_twinPick_GAB_FPC_2_scores_' num2str(rr) networks{rr} '_Scatter_' group Cov_label '.png'];  %%!!    %%!!  GAB    1/2/3/4/Dev    
        saveas(h_fig, outfilef);
        close(h_fig);  %  
        %{
        figure;
...
%         close;  
    ...
    PermPs_GAB_FDR = mafdr(PermPs_GAB, 'BHFDR', true);  %%!!  
    PermHs_GAB_FDR = PermPs_GAB_FDR <= alpha;  %%!!  
    outfile = [outputpath measure label '_mFPCA_twinPick_GAB_FPC_2_scores_PartialCorrP_' group Cov_label '.mat'];  %%!!    %%!!  GAB    1/2/3/4/Dev    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_All_withMedu', 'FPC_scores_twinPick_All_withMedu', 'FPC_2_scores_twinPick_All_withMedu', 'C_twinPick_All_withMedu', 'GAB_twinPick_All_withMedu', 'Corrs_GAB', 'Ps_GAB', 'Hs_GAB', 'Ps_GAB_FDR', 'Hs_GAB_FDR', 'PermPs_GAB', 'PermHs_GAB', 'PermPs_GAB_FDR', 'PermHs_GAB_FDR');  %%!!    %%!!  1/2/3/4/Dev    
