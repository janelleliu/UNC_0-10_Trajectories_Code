...
inds_NDD3ROIs = [213 214 252];  %%!!  %%!!  
names_funPar_NDD3ROIs = names_funPar(inds_NDD3ROIs);
num_ROIs_NDD3ROIs = length(names_funPar_NDD3ROIs);  %%!!  NDD 3 ROIs
...
%Colors = repmat([0 0.4470 0.7410], num_ROIs, 1);
Colors = [0 0.4470 0.7410; 0.3010 0.7450 0.9330; 0.6350 0.0780 0.1840]; % NDD 3 ROIs
...
for mm=6:6%1:length(measures)  %%!!    %%!!  7:8%
    measure = measures{mm};
...
outputpath = '/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/MSFPCA3_New_tables_results/mFPCA/mfpca_plot_results_Reconstruct_NDD3ROIs/';  %%!!  
...
FPC_scores = readcell([datapath 'mfpca_tra_ROIs_' measure label Cov_label '_twinPick_All_FPC_scores_1.csv'], 'DatetimeType', 'text');  %%!!    %%!!  
X_GAS_Day_Y_STDZ_Mean_mFPCA = readcell([datapath 'mfpca_tra_ROIs_' measure label Cov_label '_twinPick_All_X_GAS_Day_Y_STDZ_Mean_mFPCA_1.csv']);  %%!!  
X_GAS_Day_Y_STDZ_FPCs_mFPCA = readcell([datapath 'mfpca_tra_ROIs_' measure label Cov_label '_twinPick_All_X_GAS_Day_Y_STDZ_FPCs_mFPCA_1.csv']);  %%!!  
Original_Scale_Var_mean = readcell([datapath 'mfpca_tra_ROIs_' measure label Cov_label '_twinPick_All_Original_Scale_Var_mean_1.csv']);  %%!!  
Original_Scale_Var_std = readcell([datapath 'mfpca_tra_ROIs_' measure label Cov_label '_twinPick_All_Original_Scale_Var_std_1.csv']);  %%!!  
...
Individual_Curves_twinPick_All_NDD3ROIs = Individual_Curves_twinPick_All(:, :, inds_NDD3ROIs);
Individual_Curves_Mean_twinPick_All_NDD3ROIs = squeeze(mean(Individual_Curves_twinPick_All_NDD3ROIs, 1));
Individual_Curves_Std_twinPick_All_NDD3ROIs = squeeze(std(Individual_Curves_twinPick_All_NDD3ROIs, 0, 1));  %%!!  
...
Individual_Curves_twinPick_Normal_NDD3ROIs = Individual_Curves_twinPick_Normal(:, :, inds_NDD3ROIs);
Individual_Curves_Mean_twinPick_Normal_NDD3ROIs = squeeze(mean(Individual_Curves_twinPick_Normal_NDD3ROIs, 1));
Individual_Curves_Std_twinPick_Normal_NDD3ROIs = squeeze(std(Individual_Curves_twinPick_Normal_NDD3ROIs, 0, 1));  %%!!  
...
Individual_Curves_twinPick_NDD_NDD3ROIs = Individual_Curves_twinPick_NDD(:, :, inds_NDD3ROIs);
Individual_Curves_Mean_twinPick_NDD_NDD3ROIs = squeeze(mean(Individual_Curves_twinPick_NDD_NDD3ROIs, 1));
Individual_Curves_Std_twinPick_NDD_NDD3ROIs = squeeze(std(Individual_Curves_twinPick_NDD_NDD3ROIs, 0, 1));  %%!!  
...
Individual_Curves_twinPick_MPD_NDD3ROIs = Individual_Curves_twinPick_MPD(:, :, inds_NDD3ROIs);
Individual_Curves_Mean_twinPick_MPD_NDD3ROIs = squeeze(mean(Individual_Curves_twinPick_MPD_NDD3ROIs, 1));
Individual_Curves_Std_twinPick_MPD_NDD3ROIs = squeeze(std(Individual_Curves_twinPick_MPD_NDD3ROIs, 0, 1));  %%!!  
...
x = X_GAS_Day(X_inds); %% 
y = Individual_Curves_Mean_twinPick_All_NDD3ROIs(X_inds, :);  %%!!    %%!!  
for rr = 1:num_ROIs_NDD3ROIs
...
legend(names_funPar_NDD3ROIs', 'Location', 'northeastoutside', 'fontsize', 18, 'FontWeight', 'bold', 'Interpreter', 'none');  %%!!  Updated

std_dev = Individual_Curves_Std_twinPick_All_NDD3ROIs(X_inds, :);  %%!!    %%!!  
...
%yticks([-0.2:0.1:1.0]);  %%!!  
xlabel('GAS Day');
ylabel(['Mean Trajectory ' measure_str ' All']);  %%!!  label Cov_label  twinPick
set(gcf, 'position', [500, 500, 1200, 800]);  %%!!    %%!!  [500, 500, 1200, 800]
...
%save(outfile1, 'names_funPar_NDD3ROIs', 'groups', 'groups_s', 'GAS_rough', 'X_GAS_Day', 'subjects_twinPick_All', 'Individual_Curves_twinPick_All_NDD3ROIs', 'Individual_Curves_Mean_twinPick_All_NDD3ROIs', 'Individual_Curves_Std_twinPick_All_NDD3ROIs', 'Colors');  %%!!  %%!!  

figure;
hold on; %% 
X_inds = X_GAS_Day>=300 & X_GAS_Day<=3950;  %%!!  
x = X_GAS_Day(X_inds); %% 
y = Individual_Curves_Mean_twinPick_Normal_NDD3ROIs(X_inds, :);  %%!!    %%!!  
for rr = 1:num_ROIs_NDD3ROIs
    plot(x, y(:, rr), 'Color', Colors(rr, :), 'LineStyle', '-', 'LineWidth', linewidth);  %%    %%!!  'Marker', 'o', 
end
legend(names_funPar_NDD3ROIs', 'Location', 'northeastoutside', 'fontsize', 18, 'FontWeight', 'bold', 'Interpreter', 'none');  %%!!  Updated
std_dev = Individual_Curves_Std_twinPick_Normal_NDD3ROIs(X_inds, :);  %%!!    %%!!  
...
%yticks([-0.2:0.1:1.0]);  %%!!  
xlabel('GAS Day');
ylabel(['Mean Trajectory ' measure_str ' Normal']);  %%!!  label Cov_label  twinPick
set(gcf, 'position', [500, 500, 1200, 800]);  %%!!    %%!!  [500, 500, 1200, 800]
set(gca, 'fontsize', 18, 'FontWeight', 'bold');  %%!!  Updated
if strcmp(measure, 'Gradient2_AlignedToHCP')
    set(gca, 'YDir', 'reverse');  %%!!  reverse Transmodal-to-Primary to Primary-to-Transmodal
...
clf(gcf);
close(gcf);
outfile1 = [outputpath 'Mean_mFPCA_' measure label Cov_label '_twinPick_Normal_M_Original' FD '_notr' num2str(threshold) '_' dataset '.mat']; %%   %%!!  
save(outfile1, 'names_funPar_NDD3ROIs', 'groups', 'groups_s', 'GAS_rough', 'X_GAS_Day', 'subjects_twinPick_Normal', 'Individual_Curves_twinPick_Normal_NDD3ROIs', 'Individual_Curves_Mean_twinPick_Normal_NDD3ROIs', 'Individual_Curves_Std_twinPick_Normal_NDD3ROIs', 'Colors');  %%!!  %%!!  

figure;
hold on; %% 
X_inds = X_GAS_Day>=300 & X_GAS_Day<=3950;  %%!!  
x = X_GAS_Day(X_inds); %% 
y = Individual_Curves_Mean_twinPick_NDD_NDD3ROIs(X_inds, :);  %%!!    %%!!  
for rr = 1:num_ROIs_NDD3ROIs
    plot(x, y(:, rr), 'Color', Colors(rr, :), 'LineStyle', '-', 'LineWidth', linewidth);  %%    %%!!  'Marker', 'o', 
end
legend(names_funPar_NDD3ROIs', 'Location', 'northeastoutside', 'fontsize', 18, 'FontWeight', 'bold', 'Interpreter', 'none');  %%!!  Updated
std_dev = Individual_Curves_Std_twinPick_NDD_NDD3ROIs(X_inds, :);  %%!!    %%!!  
...
%yticks([-0.2:0.1:1.0]);  %%!!  
xlabel('GAS Day');
ylabel(['Mean Trajectory ' measure_str ' NDD']);  %%!!  label Cov_label  twinPick
set(gcf, 'position', [500, 500, 1200, 800]);  %%!!    %%!!  [500, 500, 1200, 800]
set(gca, 'fontsize', 18, 'FontWeight', 'bold');  %%!!  Updated
if strcmp(measure, 'Gradient2_AlignedToHCP')
    set(gca, 'YDir', 'reverse');  %%!!  reverse Transmodal-to-Primary to Primary-to-Transmodal
...
clf(gcf);
close(gcf);
%outfile1 = [outputpath 'Mean_mFPCA_' measure label Cov_label '_twinPick_NDD_M_Original' FD '_notr' num2str(threshold) '_' dataset '.mat']; %%   %%!!  
%save(outfile1, 'names_funPar_NDD3ROIs', 'groups', 'groups_s', 'GAS_rough', 'X_GAS_Day', 'subjects_twinPick_NDD', 'Individual_Curves_twinPick_NDD_NDD3ROIs', 'Individual_Curves_Mean_twinPick_NDD_NDD3ROIs', 'Individual_Curves_Std_twinPick_NDD_NDD3ROIs', 'Colors');  %%!!  %%!!  

figure;
hold on; %% 
X_inds = X_GAS_Day>=300 & X_GAS_Day<=3950;  %%!!  
x = X_GAS_Day(X_inds); %% 
y = Individual_Curves_Mean_twinPick_MPD_NDD3ROIs(X_inds, :);  %%!!    %%!!  
for rr = 1:num_ROIs_NDD3ROIs
    plot(x, y(:, rr), 'Color', Colors(rr, :), 'LineStyle', '-', 'LineWidth', linewidth);  %%    %%!!  'Marker', 'o', 
end
legend(names_funPar_NDD3ROIs', 'Location', 'northeastoutside', 'fontsize', 18, 'FontWeight', 'bold', 'Interpreter', 'none');  %%!!  Updated
std_dev = Individual_Curves_Std_twinPick_MPD_NDD3ROIs(X_inds, :);  %%!!    %%!!  
...
%yticks([-0.2:0.1:1.0]);  %%!!  
xlabel('GAS Day');
ylabel(['Mean Trajectory ' measure_str ' MPD']);  %%!!  label Cov_label  twinPick
set(gcf, 'position', [500, 500, 1200, 800]);  %%!!    %%!!  [500, 500, 1200, 800]
set(gca, 'fontsize', 18, 'FontWeight', 'bold');  %%!!  Updated
if strcmp(measure, 'Gradient2_AlignedToHCP')
    set(gca, 'YDir', 'reverse');  %%!!  reverse Transmodal-to-Primary to Primary-to-Transmodal
...
clf(gcf);
close(gcf);
%outfile1 = [outputpath 'Mean_mFPCA_' measure label Cov_label '_twinPick_MPD_M_Original' FD '_notr' num2str(threshold) '_' dataset '.mat']; %%   %%!!  
%save(outfile1, 'names_funPar_NDD3ROIs', 'groups', 'groups_s', 'GAS_rough', 'X_GAS_Day', 'subjects_twinPick_MPD', 'Individual_Curves_twinPick_MPD_NDD3ROIs', 'Individual_Curves_Mean_twinPick_MPD_NDD3ROIs', 'Individual_Curves_Std_twinPick_MPD_NDD3ROIs', 'Colors');  %%!!  %%!!  
...
%legend(strcat('Normal-', names_funPar_NDD3ROIs), 'Location', 'northeastoutside'); %% 
std_dev = Individual_Curves_Std_twinPick_Normal_NDD3ROIs(X_inds, :);  %%!!    %%!!  
sem = std_dev / sqrt(length(subjects_twinPick_Normal));  %%!!  standard error mean
upper_bound = y + sem;  %%!!  
lower_bound = y - sem;  %%!!  
...
legend([strcat('Normal-', names_funPar_NDD3ROIs'), strcat('NDD-', names_funPar_NDD3ROIs')], 'Location', 'northeastoutside', 'fontsize', 18, 'FontWeight', 'bold', 'Interpreter', 'none');  %%!!  Updated
std_dev = Individual_Curves_Std_twinPick_NDD_NDD3ROIs(X_inds, :);  %%!!    %%!!  
sem = std_dev / sqrt(length(subjects_twinPick_NDD));  %%!!  standard error mean
upper_bound = y + sem;  %%!!  
lower_bound = y - sem;  %%!!  
...
%yticks([-0.2:0.1:1.0]);  %%!!  
xlabel('GAS Day');
ylabel(['Mean Trajectory ' measure_str ' Normal-NDD']);  %%!!  label Cov_label  twinPick
set(gcf, 'position', [500, 500, 1200, 800]);  %%!!    %%!!  [500, 500, 1200, 800]
set(gca, 'fontsize', 18, 'FontWeight', 'bold');  %%!!  Updated
if strcmp(measure, 'Gradient2_AlignedToHCP')
    set(gca, 'YDir', 'reverse');  %%!!  reverse Transmodal-to-Primary to Primary-to-Transmodal
...
legend([strcat('Normal-', names_funPar_NDD3ROIs'), strcat('MPD-', names_funPar_NDD3ROIs')], 'Location', 'northeastoutside', 'fontsize', 18, 'FontWeight', 'bold', 'Interpreter', 'none');  %%!!  Updated
std_dev = Individual_Curves_Std_twinPick_MPD_NDD3ROIs(X_inds, :);  %%!!    %%!!  
sem = std_dev / sqrt(length(subjects_twinPick_MPD));  %%!!  standard error mean
upper_bound = y + sem;  %%!!  
lower_bound = y - sem;  %%!!  
...
%yticks([-0.2:0.1:1.0]);  %%!!  
xlabel('GAS Day');
ylabel(['Mean Trajectory ' measure_str ' Normal-MPD']);  %%!!  label Cov_label  twinPick
set(gcf, 'position', [500, 500, 1200, 800]);  %%!!    %%!!  [500, 500, 1200, 800]
set(gca, 'fontsize', 18, 'FontWeight', 'bold');  %%!!  Updated
if strcmp(measure, 'Gradient2_AlignedToHCP')
    set(gca, 'YDir', 'reverse');  %%!!  reverse Transmodal-to-Primary to Primary-to-Transmodal
