...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/MSFPCA3_New_tables_results/mFPCA/mfpca_results_GroupComp_37W/' measure label Cov_label '/'];  %%!!    %%!!  
...
for gg = 1:length(groups)
    ...
    subjects_twinPick_Normal_37W = importSubjIDs([listpath group_s '_full_subject_updated_final_twinPick_37W_Healthy.txt']);  %%!!    %%!!  Normal_37W  %%!!    
    ...
    subjects_twinPick_UNNM = union(subjects_twinPick_Normal_37W, subjects_twinPick_NDD);
    subjects_twinPick_UNNM = union(subjects_twinPick_UNNM, subjects_twinPick_MPD);  %%!!  Union of Normal_37W/NDD/MPD
    ...
    subjects_twinPick_UNNM_withMedu = subjects_twinPick_UNNM(~isnan(Medu_twinPick_UNNM));  %%!!  Union of Normal_37W/NDD/MPD & with Medu  %%!!  
    ...
    outfile = [outputpath measure label '_mFPCA_twinPick_Normal_37W_NDD_MPD_FPC_1_scores_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  Normal_37W-NDD/-MPD    1/2/3/4/Dev    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_UNNM_withMedu', 'FPC_scores_twinPick_UNNM_withMedu', 'FPC_1_scores_twinPick_UNNM_withMedu', 'C_twinPick_UNNM_withMedu', 'Bs_NDD', 'Ps_NDD', 'Hs_NDD', 'Ps_NDD_FDR', 'Hs_NDD_FDR', 'Bs_MPD', 'Ps_MPD', 'Hs_MPD', 'Ps_MPD_FDR', 'Hs_MPD_FDR');  %%!!    %%!!  1/2/3/4/Dev    
    
    for rr = 1:num_ROIs
        ROI = ROIs{rr};
        network = networks{rr};
        y_twinPick_UNNM_withMedu = FPC_1_scores_twinPick_UNNM_withMedu(:, rr);  %%!!  1/2/3/4/Dev    
        y_twinPick_UNNM_withMedu_Normal_37W = y_twinPick_UNNM_withMedu(ismember(subjects_twinPick_UNNM_withMedu, subjects_twinPick_Normal_37W));
        y_twinPick_UNNM_withMedu_NDD = y_twinPick_UNNM_withMedu(ismember(subjects_twinPick_UNNM_withMedu, subjects_twinPick_NDD));
        y_twinPick_UNNM_withMedu_MPD = y_twinPick_UNNM_withMedu(ismember(subjects_twinPick_UNNM_withMedu, subjects_twinPick_MPD));
        figure;
        Violin({y_twinPick_UNNM_withMedu_Normal_37W}, 1, 'ShowMean', true);
        Violin({y_twinPick_UNNM_withMedu_NDD}, 2, 'ShowMean', true);
        grouporder = {'Normal-37W', 'NDD'};
        xticks([1, 2]); %% 
        ...
        saveas(gcf, [outputpath measure label '_mFPCA_twinPick_Normal_37W_NDD_FPC_1_scores_ViolinPlot_' group Cov_label '_' network '.png']);  %%!!  1/2/3/4/Dev    
        close;    
        figure;
        Violin({y_twinPick_UNNM_withMedu_Normal_37W}, 1, 'ShowMean', true);
        Violin({y_twinPick_UNNM_withMedu_MPD}, 2, 'ShowMean', true);
        grouporder = {'Normal-37W', 'MPD'};
        xticks([1, 2]); %% 
        xticklabels(grouporder);
        ylabel(['FPC 1 scores: ' measure_str ' ' network]);  %%!!  1/2/3/4/Dev    
        xlim([0.5, 2.5]);
        ...
        set(gcf,'Units','pixels','Position',[200 200 560 420]);
        set(gca, 'FontSize', 12, 'FontWeight', 'bold');  %%!!    %%!!  
        saveas(gcf, [outputpath measure label '_mFPCA_twinPick_Normal_37W_MPD_FPC_1_scores_ViolinPlot_' group Cov_label '_' network '.png']);  %%!!  1/2/3/4/Dev    
        close;  
    end
    ...
    Ps_MPD_FDR = mafdr(Ps_MPD, 'BHFDR', true);
    Hs_MPD_FDR = Ps_MPD_FDR <= alpha;
    outfile = [outputpath measure label '_mFPCA_twinPick_Normal_37W_NDD_MPD_FPC_2_scores_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  Normal_37W-NDD/-MPD    1/2/3/4/Dev    
    ...
    for rr = 1:num_ROIs
        ...
        set(gcf,'Units','pixels','Position',[200 200 560 420]);
        set(gca, 'FontSize', 12, 'FontWeight', 'bold');  %%!!    %%!!  
        saveas(gcf, [outputpath measure label '_mFPCA_twinPick_Normal_37W_NDD_FPC_2_scores_ViolinPlot_' group Cov_label '_' network '.png']);  %%!!  1/2/3/4/Dev    
        close;    
        figure;
        Violin({y_twinPick_UNNM_withMedu_Normal_37W}, 1, 'ShowMean', true);
        Violin({y_twinPick_UNNM_withMedu_MPD}, 2, 'ShowMean', true);
        ...
        set(gcf,'Units','pixels','Position',[200 200 560 420]);
        set(gca, 'FontSize', 12, 'FontWeight', 'bold');  %%!!    %%!!  
        saveas(gcf, [outputpath measure label '_mFPCA_twinPick_Normal_37W_MPD_FPC_2_scores_ViolinPlot_' group Cov_label '_' network '.png']);  %%!!  1/2/3/4/Dev    
        close;  
    end
