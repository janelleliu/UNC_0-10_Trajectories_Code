...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/MSFPCA3_New_tables_results/mFPCA/mfpca_results_GroupComp_Preterm_woNDD/' measure label Cov_label '/'];  %%!!    %%!!  
...
for gg = 1:length(groups)
    ...
    C_twinPick_UNP_32W_withMedu = [Preterm_32W_twinPick_UNP_32W_withMedu, C_twinPick_UNP_32W_withMedu, Medu_twinPick_UNP_32W_withMedu, NDD_twinPick_UNP_32W_withMedu, MPD_twinPick_UNP_32W_withMedu];  %%!!    %%!!  All covs for longitudinal regression test (except for intercept 1+)
