...
ROIs_NDD3ROIs = names_funPar_NDD3ROIs';  %%!!  %%!!  
...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/Heatmap2_New_heatmaps_results/barplots_results_GroupComp_NDD3ROIs/' measure label Cov_label '/'];  %%!!    %%!!  
...
for gg = 1:length(groups)
    ...
    load(infile);
    measures_ROI_Normal_NDD3ROIs = measures_ROI(inds_Normal, inds_NDD3ROIs);  %%!!  %%!!  
    measures_ROI_NDD_NDD3ROIs = measures_ROI(inds_NDD, inds_NDD3ROIs);  %%!!  %%!!  
    measures_ROI_MPD_NDD3ROIs = measures_ROI(inds_MPD, inds_NDD3ROIs);  %%!!  %%!!  
    
    measures_ROI_Normal_NDD3ROIs_mean = mean(measures_ROI_Normal_NDD3ROIs, 1);
    measures_ROI_Normal_NDD3ROIs_sem = std(measures_ROI_Normal_NDD3ROIs, 1) / sqrt(size(measures_ROI_Normal_NDD3ROIs, 1));
    measures_ROI_NDD_NDD3ROIs_mean = mean(measures_ROI_NDD_NDD3ROIs, 1);
    measures_ROI_NDD_NDD3ROIs_sem = std(measures_ROI_NDD_NDD3ROIs, 1) / sqrt(size(measures_ROI_NDD_NDD3ROIs, 1));
    measures_ROI_MPD_NDD3ROIs_mean = mean(measures_ROI_MPD_NDD3ROIs, 1);
    measures_ROI_MPD_NDD3ROIs_sem = std(measures_ROI_MPD_NDD3ROIs, 1) / sqrt(size(measures_ROI_MPD_NDD3ROIs, 1));
    [~, rank_inds] = sort(measures_ROI_Normal_NDD3ROIs_mean, 'descend');  %%!!  ranked by Normal mean
    ROIs_NDD3ROIs_ranked = ROIs_NDD3ROIs(rank_inds);
    measures_ROI_Normal_NDD3ROIs_mean_ranked = measures_ROI_Normal_NDD3ROIs_mean(rank_inds);
    measures_ROI_Normal_NDD3ROIs_sem_ranked = measures_ROI_Normal_NDD3ROIs_sem(rank_inds);
    measures_ROI_NDD_NDD3ROIs_mean_ranked = measures_ROI_NDD_NDD3ROIs_mean(rank_inds);
    measures_ROI_NDD_NDD3ROIs_sem_ranked = measures_ROI_NDD_NDD3ROIs_sem(rank_inds);
    measures_ROI_MPD_NDD3ROIs_mean_ranked = measures_ROI_MPD_NDD3ROIs_mean(rank_inds);
    measures_ROI_MPD_NDD3ROIs_sem_ranked = measures_ROI_MPD_NDD3ROIs_sem(rank_inds);
    
    x = 1:num_ROIs_NDD3ROIs;  %%!!  
    y = [measures_ROI_Normal_NDD3ROIs_mean_ranked; measures_ROI_NDD_NDD3ROIs_mean_ranked];  %%!!  Normal-NDD
    err = [measures_ROI_Normal_NDD3ROIs_sem_ranked; measures_ROI_NDD_NDD3ROIs_sem_ranked];  %%!!  Normal-NDD
    figure;  %%!!  
    hold on
    ...
    %}
    %errorbar(x, y, err, '.k');  %%!!  
    xticks(1:num_ROIs_NDD3ROIs);  %%!!  
    xticklabels(ROIs_NDD3ROIs_ranked);  %%!!  
    xtickangle(15);  %%!!  
    %ylim(ylims(mm,:)); %%   %%!!  %%!!  %%!!  
    ...
    x = 1:num_ROIs_NDD3ROIs;  %%!!  
    y = [measures_ROI_Normal_NDD3ROIs_mean_ranked; measures_ROI_MPD_NDD3ROIs_mean_ranked];  %%!!  Normal-MPD
    err = [measures_ROI_Normal_NDD3ROIs_sem_ranked; measures_ROI_MPD_NDD3ROIs_sem_ranked];  %%!!  Normal-MPD
    figure;  %%!!  
    hold on
    b = bar(x, y, 'grouped', 'FaceColor', 'flat', 'LineWidth', 2);  %%!!  
    b(1).BarWidth = 1;  %%!!  Updated
