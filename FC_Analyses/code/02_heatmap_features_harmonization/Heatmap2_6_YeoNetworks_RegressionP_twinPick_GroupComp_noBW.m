clear
clc
% sensitivity analysis (exclude BW as covar: little difference)
...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/Heatmap2_New_heatmaps_results/barplots_results_GroupComp_noBW/' measure label Cov_label '/'];  %%!!    %%!!  
...
for gg = 1:length(groups)
    ...
    C_twinPick_UNNM_withMedu = C(ismember(subjects_twinPick_All, subjects_twinPick_UNNM_withMedu), :);  %%!!    %%!!  categorized/centered GAB+GAS+Sex for subjects_twinPick_UNNM_withMedu
