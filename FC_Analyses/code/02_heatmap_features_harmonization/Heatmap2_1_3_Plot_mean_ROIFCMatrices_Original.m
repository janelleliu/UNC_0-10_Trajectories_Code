...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/' measure label '/'];   %%!!   %%!!  
...
if strcmp(group, 'HCP')
    outfile_mean1 = [outputpath group '_mean_FC_M.1D'];  %%!!  matrix
else
    outfile_mean1 = [outputpath group '_twinPick_32W_Healthy_mean_FC_M.1D'];  %%!!  matrix
end
if exist(outfile_mean1, 'file')
    ...
    if strcmp(group, 'HCP')
        outfile_f = [outputpath group '_mean_Grouped_FC_M.png'];  %%!!  figure
    else
        outfile_f = [outputpath group '_mean_Grouped_twinPick_32W_Healthy_FC_M.png'];  %%!!  figure
    end
