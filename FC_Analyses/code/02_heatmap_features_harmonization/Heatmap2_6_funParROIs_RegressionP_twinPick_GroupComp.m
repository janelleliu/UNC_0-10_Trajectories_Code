...
for gg = 1:length(groups)
    ...
    load(infile);
    measures_ROI_twinPick_UNNM_withMedu = measures_ROI(ismember(subjects_twinPick_All, subjects_twinPick_UNNM_withMedu), :);  %%!!  
    ...
    alpha = 0.05;  %%!!  
    for rr = 1:num_ROIs
        y_twinPick_UNNM_withMedu = measures_ROI_twinPick_UNNM_withMedu(:, rr);  %%!!  
    ...
    outfile = [outputpath measure label '_Mean_twinPick_Normal_NDD_MPD_ROI_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  Normal-NDD/-MPD    
    save(outfile, 'ROIs', 'subjects_twinPick_UNNM_withMedu', 'measures_ROI_twinPick_UNNM_withMedu', 'C_twinPick_UNNM_withMedu', 'Bs_NDD', 'Ps_NDD', 'Hs_NDD', 'Ps_NDD_FDR', 'Hs_NDD_FDR', 'Bs_MPD', 'Ps_MPD', 'Hs_MPD', 'Ps_MPD_FDR', 'Hs_MPD_FDR');  %%!!    %%!!  
