...
outputpath = ['/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/Heatmap2_New_heatmaps_results/barplots_results_GroupComp_GAB_controlNDD/' measure label Cov_label '/'];  %%!!    %%!!  
...
%     subjects_twinPick_UNP_32W = union(subjects_twinPick_Normal_32W, subjects_twinPick_Preterm_32W);  %%!!  Union of Normal/Preterm 32W
    ...
    C = C(:, [1,2,4]);  %%!!  C as categorized/centered GAB+GAS+Sex for subjects_twinPick_All
    C_twinPick_All_withMedu = C(ismember(subjects_twinPick_All, subjects_twinPick_All_withMedu), :);  %%!!    %%!!  categorized/centered GAB+GAS+Sex for subjects_twinPick_UNNM_withMedu
    C_twinPick_All_withMedu = [C_twinPick_All_withMedu, Medu_twinPick_All_withMedu, NDD_twinPick_All_withMedu, MPD_twinPick_All_withMedu];  %%!!    %%!!  All covs for cross-sectional regression test (except for intercept 1+)
    ...
    outfile = [outputpath measure label '_Mean_twinPick_All_Network_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  All    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_All_withMedu', 'measures_network_twinPick_All_withMedu', 'C_twinPick_All_withMedu', 'Bs_GAB', 'Ps_GAB', 'Hs_GAB', 'Ps_GAB_FDR', 'Hs_GAB_FDR');  %%!!    %%!!  
