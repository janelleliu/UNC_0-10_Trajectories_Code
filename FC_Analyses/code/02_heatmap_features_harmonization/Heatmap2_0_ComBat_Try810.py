...
measures = ['McosSim2', 'Gradient1_AlignedToHCP', 'Gradient2_AlignedToHCP']  ##!!  'Str', 'Enodal', 'Elocal', 
for measure in measures:
  ...
  outputpath = '/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/Heatmap2_New_heatmaps_results/0_ComBat/Try810/'
