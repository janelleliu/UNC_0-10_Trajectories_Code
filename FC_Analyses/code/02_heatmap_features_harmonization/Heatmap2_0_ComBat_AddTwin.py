...
for measure in measures:
  ...
  outputpath = '/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/0NewCompleteAnalyses/Heatmap2_New_heatmaps_results_AddTwin/0_ComBat/'  ##!!  ##!!  
  ...
  for aa in range(len(ages)):
      ...
      subjects = np.loadtxt(listpath + age_s + '_full_subject_updated_final.txt', dtype=str)  ##!!  _twinPick
      masked_data_vectors = []
      ...
      Covs = np.genfromtxt('/media/zhark2/glab7/Haitao/UNC_Trajectory_heatmaps/M_FC_Z_Covs_All/M_FC_Z_Covs_All_0.3mm_notr90_UNC_'+age+'.csv', delimiter=",", skip_header=1)  ##!!  _twinPick  _twinPick
      GAS = Covs[:, 2]
      Sex = Covs[:, 4]
      Scanner = Covs[:, 5]
  ...
  age_s = '8'  ##!!  
  listpath = '/media/zhark2/glab6/Project_Replication/Preprocessed_Data/UNC/lists_0.3mm/'  ##!!  
  subjects_8 = np.loadtxt(listpath + age_s + '_full_subject_updated_final.txt', dtype=str)  ##!!  _twinPick
  masked_data_vectors = []
  ...
  age_s = '10'  ##!!  
  listpath = '/media/zhark2/glab6/Project_Replication/Preprocessed_Data/UNC/lists_0.3mm/'  ##!!  
  subjects_10 = np.loadtxt(listpath + age_s + '_full_subject_updated_final.txt', dtype=str)  ##!!  _twinPick
  masked_data_vectors = []
