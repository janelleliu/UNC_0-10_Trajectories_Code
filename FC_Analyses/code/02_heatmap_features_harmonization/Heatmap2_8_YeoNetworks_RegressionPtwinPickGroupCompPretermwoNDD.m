...
for gg = 1:length(groups)
    ...
    subjects_twinPick_Preterm_32W = importSubjIDs([listpath group_s '_full_subject_updated_final_twinPick_Preterm_32W_woNDD.txt']);  %%!!    %%!!  Preterm 32W  
    ...
    subjects_twinPick_UNP_32W_withMedu = subjects_twinPick_UNP_32W(~isnan(Medu_twinPick_UNP_32W));  %%!!  Union of Normal/NDD/MPD & with Medu  %%!!  
    ...
    C_twinPick_UNP_32W_withMedu = C(ismember(subjects_twinPick_All, subjects_twinPick_UNP_32W_withMedu), :);  %%!!    %%!!  categorized/centered GAS+Sex for subjects_twinPick_UNNM_withMedu
    C_twinPick_UNP_32W_withMedu = [Preterm_32W_twinPick_UNP_32W_withMedu, C_twinPick_UNP_32W_withMedu, Medu_twinPick_UNP_32W_withMedu, NDD_twinPick_UNP_32W_withMedu, MPD_twinPick_UNP_32W_withMedu];  %%!!    %%!!  All covs for cross-sectional regression test (except for intercept 1+)
    
    infile = [datapath measure label '_Mean_twinPick_Heatmap_' group Cov_label '.mat'];  %%!!  All
    load(infile);
    measures_network_twinPick_UNP_32W_withMedu = measures_network(ismember(subjects_twinPick_All, subjects_twinPick_UNP_32W_withMedu), :);  %%!!  
    ...
    alpha = 0.05;  %%!!  
    for rr = 1:num_ROIs
        y_twinPick_UNP_32W_withMedu = measures_network_twinPick_UNP_32W_withMedu(:, rr);  %%!!  
    ...
    outfile = [outputpath measure label '_Mean_twinPick_Normal_Preterm_32W_Network_RegressionP_' group Cov_label '.mat'];  %%!!    %%!!  Normal-Preterm 32W    
    save(outfile, 'ROIs', 'networks', 'subjects_twinPick_UNP_32W_withMedu', 'measures_network_twinPick_UNP_32W_withMedu', 'C_twinPick_UNP_32W_withMedu', 'Bs_Preterm', 'Ps_Preterm', 'Hs_Preterm', 'Ps_Preterm_FDR', 'Hs_Preterm_FDR');  %%!!    %%!!  
